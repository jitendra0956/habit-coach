...
# ── Hide Streamlit menu / footer / GitHub info ────────────────────────────────
...
# ── Imports after UI config ───────────────────────────────────────────────────
from db.queries import get_db_connection, get_active_plan
...
if is_logged_in():
    ...
    if not active_plan:
        ...
        st.page_link(
            ...
            label="Create your personalized plan →",
            icon="✨"
        )
